...
%prep
%setup -q -n Metrics-Any-0.05
cd %{_builddir}/Metrics-Any-0.05
...
cp %{_builddir}/Metrics-Any-0.05/LICENSE %{buildroot}/usr/share/package-licenses/perl-Metrics-Any/7e88e362b09da4b18d7e611c14945b5734383496
if test -f Makefile.PL; then
